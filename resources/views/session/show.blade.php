<x-layout>
    ...
    <div class="h-screen">
        ...
        <form action="/my-account" method="POST" class="max-w-lg mx-auto my-8">
            ...
            <x-form.text-input name="password" placeholder="Update password" type="password" class="mb-6" />
            <x-form.text-input name="confirm password" placeholder="Confirm password" type="password" class="mb-6" />
